            ...
            { data: 'semester.name', "width": "20%", className: "text-center" },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                            <a href="/manager/magazine/edit/${data}" class="btn btn-success text-white" style="cursor:pointer; width:80px;">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="/manager/magazine/delete/${data}" class="btn btn-danger text-white" style="cursor:pointer; width:90px;">
